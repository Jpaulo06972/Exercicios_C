...
// Inclui a interface do Core para gerenciar a fila
...
int main() {
    ...
    // Aloca dinamicamente e inicializa a estrutura da fila
    Queue* myQueue = createQueue();

    // Valida se a fila foi criada com sucesso na memória
    if (myQueue != NULL) {

        // Inicia o fluxo principal passando o controle para a interface do menu
        runMenu(myQueue);

        // Ao fechar o menu, garante a desalocação completa de todos os nós e da fila
